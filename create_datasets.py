...
for k, v in tables.items():
    ...
    query_string = "SELECT {} FROM \"{}\"".format(joined_cols, query.table_name)
...
dataset = pd.merge(tables['ratings']['df'], tables['tracks']['df'], on='trackid', how='inner')
dataset = pd.merge(dataset, tables['user_5star_features']['df'], on='userid', how='inner')
